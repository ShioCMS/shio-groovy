package com.viglet.shio.groovy.template;
...
public class ShMustacheEngine extends TemplateEngine {
    private boolean verbose;
    private static int counter = 1;

    private GroovyShell groovyShell;

    public ShMustacheEngine() {
        this(GroovyShell.class.getClassLoader());
    }

    public ShMustacheEngine(boolean verbose) {
        this(GroovyShell.class.getClassLoader());
        setVerbose(verbose);
    }

    public ShMustacheEngine(ClassLoader parentLoader) {
        this(new GroovyShell(parentLoader));
    }

    public ShMustacheEngine(GroovyShell groovyShell) {
